...
def test_mandatory_escalation_override(cf):
    ...
    vitals = {"sbp": 185, "dbp": 110, "glucose_mgdl": 100, "heart_rate": 80, "spo2": 96}
...
def test_no_med_reminder_high_adherence(cf):
    vitals = {"sbp": 120, "dbp": 78, "glucose_mgdl": 100, "heart_rate": 72, "spo2": 97}
...
def test_action_mask_blocks_unnecessary_escalation(cf):
    vitals = {"sbp": 118, "dbp": 76, "glucose_mgdl": 95, "heart_rate": 70, "spo2": 98}
